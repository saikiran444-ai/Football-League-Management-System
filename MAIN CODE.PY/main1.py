...
class login_window:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file=r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/bg3.png")

        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        original_frame_image = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/loginbg1.jpg")
        resized_frame_image = original_frame_image.resize((400, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_frame_image)

        original_frame_image1 = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/FFF.png")
        ...
        ##############ICON IMAGES###########
        #LOGIN BUTTON
        loginbtn=Button(self.frame_border,command=self.login,text="Login",font=("times new roman", 15, "bold"),bd=3,relief=RIDGE,fg="black",bg="purple",activeforeground="white",activebackground="dark blue")
        loginbtn.place(x=540,y=335,width=120,height=35)

        # REGISTERBUTTON
        registerbtn=Button(self.frame_border,command=self.register_window,text="New User Register",font=("times new roman", 10, "bold"),borderwidth=0,fg="black",bg="NAVY blue",activeforeground="black",activebackground="dark blue")
        registerbtn.place(x=420,y=400,width=200,height=35)

        # FORGOT PASS BUTTON
        forgetpassbtn=Button(self.frame_border,command=self.forgot_password_window,text="Forget Password",font=("times new roman", 10, "bold"),borderwidth=0,fg="black",bg="NAVY blue",activeforeground="black",activebackground="dark blue")
    ...
    def login(self):
        if self.txtuser.get() == "" or self.txtpass.get() == "":
            ...
            conn = mysql.connector.connect(host="localhost", user="testuser", password="TestPassword123", database="sys")
...
class Register:
    def __init__(self, root):
        ...
        #########bg image#####
        self.bg = ImageTk.PhotoImage(file=r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/qnUbi9.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        #########bg image#####
        self.bg1 = ImageTk.PhotoImage(file=r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/CR7.png")
        ...
        ########################button
        img=Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/images.jpg")
        ...
        img1=Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/login-png-royalty-free_60202203531a5.png")
...
class AdminWindow:
    def __init__(self, root):
        ...
        original_frame_image = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/leftframe.jpg")
        ...
        get_str= Button(self.frame_border,command=self.dis_window, text="DISPLAY", font=("times new roman", 25, "bold"),bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white",activebackground="dark blue")
        get_str.place(x=480, y=5, width=315, height=135)

        insetbtn= Button(self.frame_border,command=self.ins_window, text="INSERT", font=("times new roman", 25, "bold"),bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white",activebackground="dark blue")
        insetbtn.place(x=480, y=143, width=315, height=135)

        deletebtn = Button(self.frame_border,command=self.del_window, text="DELETE", font=("times new roman", 25, "bold"),bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white",activebackground="dark blue")
        deletebtn.place(x=480, y=281, width=315, height=135)

        updatebtn = Button(self.frame_border,command=self.upt_window, text="UPDATE", font=("times new roman", 25, "bold"),bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white",activebackground="dark blue")
        updatebtn.place(x=480, y=420, width=315, height=135)

        backbtn = Button(self.root,command=self.return_login, text="BACK", font=("times new roman", 15, "bold"),bd=3, relief=RIDGE, fg="black", bg="PURPLE", activeforeground="white",activebackground="dark blue")
...
class Insert_win:
    def __init__(self, root):
        ...
        original_frame_image = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/leftframe2.jpg")
        ...
        del_plybtn= Button(self.frame_border,command=self.player_win, text="INSERT PLAYER", font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white", activebackground="dark blue")
        del_plybtn.place(x=5, y=410, width=300, height=135)

        # --------------------------------------3-------------------------------

        original_frame_ima = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/matchesdis.jpg")
        ...
        del_plyb= Button(self.frame_bord,command=self.match_win, text="INSERT MATCH", font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)

        #---------------------------------------4------------------------------------------------

        original_frame_ima = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/ranking.jpg")
        ...
        del_plyb= Button(self.frame_bord,command=self.team_s, text="INSERT TEAM RANK", font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
...
class Delete_win:
    def __init__(self, root):
        ...
        del_plybtn= Button(self.frame_border,command=self.del_player_info_s, text="DELETE PLAYER", font=("times new roman", 20, "bold"),bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white",activebackground="dark blue")
        del_plybtn.place(x=5, y=410, width=300, height=135)
...
class update_win:
    def __init__(self, root):
        ...
        original_frame_image = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/update_player.jpg")
        ...
        del_plybtn= Button(self.frame_border,command=self.upd_player_info_s, text="UPDATE PLAYER", font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white", activebackground="dark blue")
        del_plybtn.place(x=5, y=410, width=300, height=135)

        # --------------------------------------3-------------------------------

        original_frame_ima = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/update_match.jpg")
        resized_frame_ima = original_frame_ima.resize((300, 425), Image.BICUBIC)
        self.bg2 = ImageTk.PhotoImage(resized_frame_ima)
        ...
        del_plyb= Button(self.frame_bord,command=self.upd_MATCH_s, text="UPDATE MATCH", font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
        ...
        del_plyb= Button(self.frame_bord,command=self.upd_team_s, text="UPDATE TEAM RANK", font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
...
class display_win:
    def __init__(self, root):
        ...
        original_frame_image = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/dis_team.jpg")
        resized_frame_image = original_frame_image.resize((300, 400), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_frame_image)
        ...
        del_plybtn= Button(self.frame_border,command=self.disteam_info_s, text="DISPLAY TEAM", font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white", activebackground="dark blue")
        del_plybtn.place(x=5, y=410, width=300, height=135)

        # --------------------------------------3-------------------------------

        original_frame_ima = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/leftframe2.jpg")
        ...
        del_plyb= Button(self.frame_bord,command=self.playerinfo_s, text="PLAYER INFO", font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
        ...
        del_plyb= Button(self.frame_bord,command=self.MATCHES, text="DISPLAY MATCHES", font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
        ...
        del_plyb= Button(self.frame_bord,command=self.RANKING_s, text="DISPLAY TEAM RANK", font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="black", bg="dark blue", activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
...
class player_info_window:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/UPDATE PLAYER.jpg")
        ...
        ########################button
        donebtn = Button(self.root,command=self.Done, text="DONE", font=("times new roman", 15, "bold"),bd=3, relief=RIDGE, fg="black", bg="PURPLE", activeforeground="white",activebackground="dark blue")
...
class match_info_win:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/insert match.png")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
        ...
        ############### ROW 1 FIRST NAME & LAST NAME
        match_id=Label(frame,text="Match ID",font=("times new roman",15,"bold"),bg="white",fg="black")
        ...
        ########################button
        donebtn = Button(self.root,command=self.Done_, text="DONE", font=("times new roman", 15, "bold"),bd=3, relief=RIDGE, fg="black", bg="PURPLE", activeforeground="white",activebackground="dark blue")
        donebtn.place(x=1100, y=500, width=75, height=50)
...
class team_stand:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/ranking.jpg")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
        ...
        ############### ROW 1 FIRST NAME & LAST NAME
        TEAM_ID=Label(frame,text="TEAM ID",font=("times new roman",15,"bold"),bg="white",fg="black")
        ...
        ########################button
        donebtn = Button(self.root,command=self.Done__, text="DONE", font=("times new roman", 15, "bold"),bd=3, relief=RIDGE, fg="black", bg="PURPLE", activeforeground="white",activebackground="dark blue")
        donebtn.place(x=1100, y=500, width=75, height=50)
...
class upd_team_stand:
    def __init__(self, root):
        ...
        ########################button
        donebtn = Button(self.root,command=self.Done1, text="DONE", font=("times new roman", 15, "bold"),bd=3, relief=RIDGE, fg="black", bg="PURPLE", activeforeground="white",activebackground="dark blue")
        donebtn.place(x=1100, y=500, width=75, height=50)
...
class upd_match_info_win:
    def __init__(self, root):
        ...
        ########################button
        donebtn = Button(self.root,command=self.Done2, text="DONE", font=("times new roman", 15, "bold"),bd=3, relief=RIDGE, fg="black", bg="PURPLE", activeforeground="white",activebackground="dark blue")
        donebtn.place(x=1100, y=500, width=75, height=50)
...
class upd_player_info_window:
    def __init__(self, root):
        ...
        ########################button
        donebtn = Button(self.root,command=self.Done5, text="DONE", font=("times new roman", 15, "bold"),bd=3, relief=RIDGE, fg="black", bg="PURPLE", activeforeground="white",activebackground="dark blue")
        donebtn.place(x=1100, y=500, width=75, height=50)
...
class del_player_info_window:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/CR7.png")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
        ...
        deletebtn2 = Button(frame,command=self.Done6, text="DELETE", font=("times new roman", 15, "bold"),bd=3, relief=RIDGE, fg="black", bg="RED", activeforeground="white",activebackground="dark blue")
...
class display_TEAMS_win:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file=r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/uefa-champions-league-star-bowl-rlsrfh81jsb88ed1.jpg")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        ######### Resize and display the frame image #####
        original_frame_image = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/frame display.png")
...
class display_real_win:
    def __init__(self, root):
        ...
        original_bg = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/bg2321.png")
...
class display_BARCA_win:
    def __init__(self, root):
        ...
        original_bg = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/new bg.png")
        resized_bg = original_bg.resize((1400, 750), Image.BICUBIC)  # Set the desired width and height
        self.bg = ImageTk.PhotoImage(resized_bg)
        ...
        # Button to refresh data
        refresh_button = Button(self.root, text="Refresh", command=self.display_data,font=("times new roman", 20, "bold"), borderwidth=4, fg="black",
                                bg="red", activeforeground="black", activebackground="red")
        refresh_button.place(x=600, y=610)
...
class display_psg_win:
    def __init__(self, root):
        ...
        original_bg = Image.open(r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/bgweq21.png")
        resized_bg = original_bg.resize((1400, 750), Image.BICUBIC)  # Set the desired width and height
        self.bg = ImageTk.PhotoImage(resized_bg)
...
class display_MATCHESSSS_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file=r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/MATCHES SCH.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)
...
class display_RANK_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file=r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/STANDING.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)
...
class display_playerinfo_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file=r"/Users/kiran/Downloads/DBMS GUI PROJECT/images/PLAYER INFO.png")
        lbl_bg = Label(self.root, image=self.bg)
        ...
        search_button = Button(frame, text="Search", command=self.search_data, font=("times new roman", 15, "bold"),
                               borderwidth=4, fg="black", bg="green", activeforeground="black", activebackground="green")
