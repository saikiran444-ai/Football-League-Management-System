...
class update_win:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file=r"Cfrom tkinter import *
...
class login_window:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\91798\Desktop\DBMS GUI PROJECT\bg3.png")

        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        original_frame_image = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\loginbg1.jpg")
        resized_frame_image = original_frame_image.resize((400, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_frame_image)

        original_frame_image1 = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\FFF.png")
        ...
        get_str = Label(self.frame_border, text="COPY RIGHT OWNER S.H.A.Y ",
                        font=("times new roman", 10, "bold"), fg="RED", bg='NAVY blue')
        get_str.place(x=470, y=535)

        # # label
        username = Label(self.frame_border, text="Username:", font=("times new roman", 15, "bold"), fg="white",
                         bg='NAVY blue')
        ...
        password = Label(self.frame_border, text="Password:", font=("times new roman", 15, "bold"), fg="white",
                         bg='NAVY blue')
        password.place(x=420, y=210)

        self.txtpass = ttk.Entry(self.frame_border, font=("times new roman", 15, "bold"),
                                 show='*')  # Use show="*" to hide the password
        self.txtpass.place(x=420, y=240, width=350)  # Adjust the y-coordinate to place it correctly

        ##############ICON IMAGES###########
        # LOGIN BUTTON
        loginbtn = Button(self.frame_border, command=self.login, text="Login", font=("times new roman", 15, "bold"),
                          bd=3, relief=RIDGE, fg="white", bg="purple", activeforeground="white",
                          activebackground="NAVY blue")
        loginbtn.place(x=540, y=335, width=120, height=35)

        # REGISTERBUTTON
        registerbtn = Button(self.frame_border, command=self.register_window, text="New User Register",
                             font=("times new roman", 10, "bold"), borderwidth=0, fg="white", bg="NAVY blue",
                             activeforeground="black", activebackground="dark blue")
        registerbtn.place(x=420, y=400, width=200, height=35)

        # FORGOT PASS BUTTON
        forgetpassbtn = Button(self.frame_border, command=self.forgot_password_window, text="Forget Password",
                               font=("times new roman", 10, "bold"), borderwidth=0, fg="white", bg="NAVY blue",
                               activeforeground="black", activebackground="dark blue")
    ...
    def login(self):
        if self.txtuser.get() == "" or self.txtpass.get() == "":
            ...
            conn = mysql.connector.connect(host="localhost", user="root", password="Saiabhiram", database="sys")
    ...
    def forgot_password_window(self):
        if self.txtuser.get() == "":
            ...
            if row == None:
                ...
                l = Label(self.root2, text="Forgot Password", font=("times new roman", 20, "bold"), fg="red",
                          bg='white')
...
class Register:
    def __init__(self, root):
        ...
        #########bg image#####
        self.bg = ImageTk.PhotoImage(file="C:/Users/91798/Desktop/DBMS GUI PROJECT/qnUbi9.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        #########bg image#####
        self.bg1 = ImageTk.PhotoImage(file=r"C:\Users\91798\Desktop\DBMS GUI PROJECT\CR7.png")
        ...
        register_lbl = Label(frame, text="REGISTER HERE", font=("times new roman", 20, "bold"), fg="dark red",
                             bg="white")
        ...
        self.txt_Confirm_pswd = ttk.Entry(frame, textvariable=self.var_Confirms_pswd,
        ...
        ########################button
        img = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\images.jpg")
        ...
        img1 = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\login-png-royalty-free_60202203531a5.png")
...
class AdminWindow:
    def __init__(self, root):
        ...
        original_frame_image = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\leftframe.jpg")
        ...
        get_str = Button(self.frame_border, command=self.dis_window, text="DISPLAY",
                         font=("times new roman", 25, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                         activeforeground="white", activebackground="dark blue")
        get_str.place(x=480, y=5, width=315, height=135)

        insetbtn = Button(self.frame_border, command=self.ins_window, text="INSERT",
                          font=("times new roman", 25, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                          activeforeground="white", activebackground="dark blue")
        insetbtn.place(x=480, y=143, width=315, height=135)

        deletebtn = Button(self.frame_border, command=self.del_window, text="DELETE",
                           font=("times new roman", 25, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                           activeforeground="white", activebackground="dark blue")
        deletebtn.place(x=480, y=281, width=315, height=135)

        updatebtn = Button(self.frame_border, command=self.upt_window, text="UPDATE",
                           font=("times new roman", 25, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                           activeforeground="white", activebackground="dark blue")
        updatebtn.place(x=480, y=420, width=315, height=135)

        backbtn = Button(self.root, command=self.return_login, text="BACK", font=("times new roman", 15, "bold"), bd=3,
                         relief=RIDGE, fg="white", bg="PURPLE", activeforeground="white", activebackground="dark blue")
...
class Insert_win:
    def __init__(self, root):
        ...
        original_frame_image = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\leftframe2.jpg")
        ...
        del_plybtn = Button(self.frame_border, command=self.player_win, text="INSERT PLAYER",
                            font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                            activeforeground="white", activebackground="dark blue")
        del_plybtn.place(x=5, y=410, width=300, height=135)

        # --------------------------------------3-------------------------------

        original_frame_ima = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\matchesdis.jpg")
        ...
        del_plyb = Button(self.frame_bord, command=self.match_win, text="INSERT MATCH",
                          font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                          activeforeground="white", activebackground="dark blue")
        ...
        original_frame_ima = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\ranking.jpg")
        ...
        del_plyb = Button(self.frame_bord, command=self.team_s, text="INSERT TEAM RANK",
                          font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                          activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
...
class Delete_win:
    def __init__(self, root):
        ...
        del_plybtn = Button(self.frame_border, command=self.del_player_info_s, text="DELETE PLAYER",
                            font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                            activeforeground="white", activebackground="dark blue")
        del_plybtn.place(x=5, y=410, width=300, height=135)
...
:\Users\91798\Desktop\DBMS GUI PROJECT\bg3.png")
        ...
        original_frame_image = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\update_player.jpg")
        ...
        del_plybtn = Button(self.frame_border, command=self.upd_player_info_s, text="UPDATE PLAYER",
                            font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                            activeforeground="white", activebackground="dark blue")
        del_plybtn.place(x=5, y=410, width=300, height=135)
        ...
        original_frame_ima = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\update_match.jpg")
        resized_frame_ima = original_frame_ima.resize((300, 425), Image.BICUBIC)
        self.bg2 = ImageTk.PhotoImage(resized_frame_ima)
        ...
        del_plyb = Button(self.frame_bord, command=self.upd_MATCH_s, text="UPDATE MATCH",
                          font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                          activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
        ...
        del_plyb = Button(self.frame_bord, command=self.upd_team_s, text="UPDATE TEAM RANK",
                          font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                          activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
...
class display_win:
    def __init__(self, root):
        ...
        original_frame_image = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\dis_team.jpg")
        resized_frame_image = original_frame_image.resize((300, 400), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_frame_image)
        ...
        del_plybtn = Button(self.frame_border, command=self.disteam_info_s, text="DISPLAY TEAM",
                            font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                            activeforeground="white", activebackground="dark blue")
        del_plybtn.place(x=5, y=410, width=300, height=135)
        ...
        original_frame_ima = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\leftframe2.jpg")
        ...
        del_plyb = Button(self.frame_bord, command=self.playerinfo_s, text="PLAYER INFO",
                          font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                          activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
        ...
        del_plyb = Button(self.frame_bord, command=self.MATCHES, text="DISPLAY MATCHES",
                          font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                          activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
        ...
        del_plyb = Button(self.frame_bord, command=self.RANKING_s, text="DISPLAY TEAM RANK",
                          font=("times new roman", 20, "bold"), bd=3, relief=RIDGE, fg="white", bg="dark blue",
                          activeforeground="white", activebackground="dark blue")
        del_plyb.place(x=5, y=410, width=300, height=135)
...
class player_info_window:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\UPDATE PLAYER.jpg")
        ...
        self.var_check = IntVar()
        self.checkbtn = Checkbutton(frame, variable=self.var_check, text="Are you sure",
                                    font=("times new roman", 15, "bold"), onvalue=1, offvalue=0)
        self.checkbtn.place(x=50, y=350)
        ...
        ########################button
        donebtn = Button(self.root, command=self.Done, text="DONE", font=("times new roman", 15, "bold"), bd=3,
                         relief=RIDGE, fg="white", bg="PURPLE", activeforeground="white", activebackground="dark blue")
    ...
    def Done(self):
        if (
            ...
            try:
                ...
                if err.errno == 1644:
                    # --------------------------------
                    messagebox.showerror("Error", "Cannot insert more than 11 players with the same team_id",
                                         parent=self.root)
                else:
...
class match_info_win:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\insert match.png")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
        ...
        ########################button
        donebtn = Button(self.root, command=self.Done_, text="DONE", font=("times new roman", 15, "bold"), bd=3,
                         relief=RIDGE, fg="white", bg="PURPLE", activeforeground="white", activebackground="dark blue")
        donebtn.place(x=1100, y=500, width=75, height=50)
    ...
    def Done_(self):
        if (
            ...
            messagebox.showerror("Error",
                                 "Please enter valid numeric values for Match ID, HomeTeam ID, and AwayTeam ID",
                                 parent=self.root)
        elif not self.var_check.get():
            messagebox.showerror("Error", "Please Make Sure", parent=self.root)
        else:
...
class team_stand:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\ranking.jpg")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
        ...
        ########################button
        donebtn = Button(self.root, command=self.Done__, text="DONE", font=("times new roman", 15, "bold"), bd=3,
                         relief=RIDGE, fg="white", bg="PURPLE", activeforeground="white", activebackground="dark blue")
        donebtn.place(x=1100, y=500, width=75, height=50)
    ...
    def Done__(self):
        if (
            ...
            messagebox.showerror("Error",
                                 "Please enter valid numeric values and make sure to check the confirmation checkbox",
                                 parent=self.root)
        else:
            conn = mysql.connector.connect(host="localhost", user="root", password="Saiabhiram", database="sys")
            my_cursor = conn.cursor()
...
class upd_team_stand:
    def __init__(self, root):
        ...
        ########################button
        donebtn = Button(self.root, command=self.Done1, text="DONE", font=("times new roman", 15, "bold"), bd=3,
                         relief=RIDGE, fg="white", bg="PURPLE", activeforeground="white", activebackground="dark blue")
        donebtn.place(x=1100, y=500, width=75, height=50)
...
class upd_match_info_win:
    def __init__(self, root):
        ...
        ########################button
        donebtn = Button(self.root, command=self.Done2, text="DONE", font=("times new roman", 15, "bold"), bd=3,
                         relief=RIDGE, fg="white", bg="PURPLE", activeforeground="white", activebackground="dark blue")
        donebtn.place(x=1100, y=500, width=75, height=50)
...
class upd_player_info_window:
    def __init__(self, root):
        ...
        ########################button
        donebtn = Button(self.root, command=self.Done5, text="DONE", font=("times new roman", 15, "bold"), bd=3,
                         relief=RIDGE, fg="white", bg="PURPLE", activeforeground="white", activebackground="dark blue")
        donebtn.place(x=1100, y=500, width=75, height=50)
        ...
        if (
            ...
            try:
                ...
                if err.errno == 1644:
                    ...
                    messagebox.showerror("Error", "Cannot update to more than 11 players with the same team_id",
                                         parent=self.root)
                else:
                    # Handle other MySQL errors
                    messagebox.showerror("MySQL Error", f"Error: {err}", parent=self.root)
...
class del_player_info_window:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\CR7.png")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
        ...
        deletebtn2 = Button(frame, command=self.Done6, text="DELETE", font=("times new roman", 15, "bold"), bd=3,
                            relief=RIDGE, fg="white", bg="RED", activeforeground="white", activebackground="dark blue")
    ...
    def Done6(self):
        if not self.var_player_id.get():
            ...
            confirmation = messagebox.askyesno("Confirmation",
                                               "Are you sure you want to delete this player's information?",
                                               parent=self.root)
            if confirmation:
                conn = mysql.connector.connect(host="localhost", user="root", password="Saiabhiram", database="sys")
                my_cursor = conn.cursor()
...
class display_TEAMS_win:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(
            file=r"C:\Users\91798\Desktop\DBMS GUI PROJECT\uefa-champions-league-star-bowl-rlsrfh81jsb88ed1.jpg")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        ######### Resize and display the frame image #####
        original_frame_image = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\frame display.png")
        ...
        # BARCELONA BUTTON
        bar_btn = Button(left_lbl, text="BARCELONA", command=self.barca_s, font=("times new roman", 20, "bold"),
                         borderwidth=4, fg="dark blue",
                         bg="yellow", activeforeground="black", activebackground="red")
        bar_btn.place(x=43, y=30, width=205, height=35)

        # # REAL MADRID
        rea_btn = Button(left_lbl, text="REAL MADRID", command=self.real_madrid_s, font=("times new roman", 20, "bold"),
                         borderwidth=4, fg="BLUE",
                         bg="yellow", activeforeground="black", activebackground="red")
        rea_btn.place(x=340, y=30, width=205, height=35)

        # PSG BUTTON
        psg_btn = Button(left_lbl, text="PSG", command=self.psg_s, font=("times new roman", 20, "bold"), borderwidth=4,
                         fg="red",
                         bg="yellow", activeforeground="black", activebackground="red")
...
class display_real_win:
    def __init__(self, root):
        ...
        original_bg = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\bg2321.png")
        ...
        refresh_button = Button(self.root, text="Refresh", command=self.display_data,
                                font=("times new roman", 20, "bold"), borderwidth=4, fg="white",
...
class display_BARCA_win:
    def __init__(self, root):
        ...
        original_bg = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\new bg.png")
        resized_bg = original_bg.resize((1400, 750), Image.BICUBIC)  # Set the desired width and height
        self.bg = ImageTk.PhotoImage(resized_bg)
...
class display_psg_win:
    def __init__(self, root):
        ...
        original_bg = Image.open(r"C:\Users\91798\Desktop\DBMS GUI PROJECT\bgweq21.png")
        resized_bg = original_bg.resize((1400, 750), Image.BICUBIC)  # Set the desired width and height
        self.bg = ImageTk.PhotoImage(resized_bg)
...
class display_MATCHESSSS_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\91798\Desktop\DBMS GUI PROJECT\MATCHES SCH.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)
        ...
        self.treeview = ttk.Treeview(frame_border,
                                     columns=('MATCH_ID', 'DATE', 'VENUE', 'RESULT', 'HOMETEAM', 'AWAYTEAM'))
...
class display_RANK_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\91798\Desktop\DBMS GUI PROJECT\STANDING.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)
...
class display_playerinfo_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\91798\Desktop\DBMS GUI PROJECT\PLAYER INFO.png")
        lbl_bg = Label(self.root, image=self.bg)
        ...
        self.treeview = ttk.Treeview(frame_border, columns=(
        'PLAYER_ID', 'TEAM_ID', 'TEAM_NAME', 'FIRST_NAME', 'LAST_NAME', 'POSITON', 'JERSEY_NO'))
        ...
        self.entry_fname = Entry(frame, textvariable=self.var_fname, font=("times new roman", 15, "bold"), bd=5,
                                 relief=GROOVE)
        ...
        self.entry_lname = Entry(frame, textvariable=self.var_lname, font=("times new roman", 15, "bold"), bd=5,
                                 relief=GROOVE)
        ...
        self.entry_team = Entry(frame, textvariable=self.var_Teamid, font=("times new roman", 15, "bold"), bd=5,
                                relief=GROOVE)
        ...
        search_button = Button(frame, text="Search", command=self.search_data, font=("times new roman", 15, "bold"),
                               borderwidth=4, fg="white", bg="green", activeforeground="black",
